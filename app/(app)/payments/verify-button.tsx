...
export function VerifyPaymentButton({ id }: { id: string }) {
  ...
  return (
    <div className="flex flex-col items-end gap-1">
      <button onClick={click} disabled={pending} className="bg-brand rounded-field px-3 py-2 text-[12px] font-bold text-white disabled:opacity-50">{pending ? "…" : "Zweryfikuj"}</button>
