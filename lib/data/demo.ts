...
].map((x) => ({ last_activity_at: now, auto_close_blocked: false, lost_reason: null, reactivation_count: 0, reactivated_at: null, previous_status: null, olx_last_message: null, ...x })) as unknown as InquiryWithCustomer[];
