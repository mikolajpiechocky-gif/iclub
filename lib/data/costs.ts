...
const DEMO_COSTS: CostWithJob[] = [
  { id: "demo-cost1", job_id: "demo-job-1", business_line: null, job: { id: "demo-job-1", title: "Osiemnastka" }, category: "Paliwo", amount: 240, spent_on: "2026-07-18", note: "Tankowanie Orlen", status: "PENDING", created_at: "2026-07-18T10:00:00.000Z", updated_at: "2026-07-18T10:00:00.000Z" },
  { id: "demo-cost2", job_id: "demo-job-1", business_line: null, job: { id: "demo-job-1", title: "Osiemnastka" }, category: "Autostrada", amount: 45, spent_on: "2026-07-18", note: null, status: "VERIFIED", created_at: "2026-07-18T10:00:00.000Z", updated_at: "2026-07-18T10:00:00.000Z" },
  { id: "demo-cost3", job_id: "demo-job-2", business_line: null, job: { id: "demo-job-2", title: "Wesele" }, category: "Szampan", amount: 120, spent_on: "2026-07-18", note: null, status: "PENDING", created_at: "2026-07-18T10:00:00.000Z", updated_at: "2026-07-18T10:00:00.000Z" },
];

export interface CostInput {
  job_id: string | null;
  business_line?: string | null;         // ręczne przypisanie do linii (ICLUB / EQUIPMENT_RENTAL) — gdy brak zlecenia
  category: string;
  amount: number;
