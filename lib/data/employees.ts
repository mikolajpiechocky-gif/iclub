...
const DEMO_EMPLOYEES: EmployeeWithRate[] = [
  { ...DEMO_PROFILE, full_name: "Mikołaj", role: "OWNER", rate: null },
  {
    ...
    rate: { profile_id: "demo-emp1", rate_model: "FLAT_PLUS_BONUS", hourly_rate: null, iclub_flat: 250, far_bonus: 100, gastro_bonus: 80, review_bonus: 30, reel_bonus: 30, upsell_percent: 15, notes: null, iclub_settlement_mode: "THRESHOLD", iclub_threshold: 4, iclub_free_hours: 8, iclub_free_hourly: 32.4 },
  },
  {
    id: "demo-emp2", full_name: "Kuba L.", role: "EMPLOYEE",
    rate: { profile_id: "demo-emp2", rate_model: "HOURLY", hourly_rate: 40, iclub_flat: null, far_bonus: null, gastro_bonus: null, review_bonus: null, reel_bonus: null, upsell_percent: 15, notes: null, iclub_settlement_mode: "FLAT", iclub_threshold: null, iclub_free_hours: null, iclub_free_hourly: null },
  },
];
...
export interface EmployeeRateInput {
  ...
  iclub_free_hours: number | null;
  iclub_free_hourly: number | null;
}
